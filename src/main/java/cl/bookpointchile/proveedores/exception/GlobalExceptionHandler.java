...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ProveedorNoEncontradoException.class, ResourceNotFoundException.class})
    ...
    public ResponseEntity<ErrorResponse> handleInvalidOrder(OrdenCompraInvalidaException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
